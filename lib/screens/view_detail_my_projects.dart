...
import 'package:vyaapaar/components/complete_popup.dart';

final Firestore firestoreInstance = Firestore.instance;

class ViewDetailMyProject extends StatefulWidget {
  static const String id = "View My Project";

  const ViewDetailMyProject({
    Key key,
  ...
  @override
  _ViewDetailMyProjectState createState() => _ViewDetailMyProjectState();
}

class _ViewDetailMyProjectState extends State<ViewDetailMyProject> {
  ...
  void handleCompleteProject() async {
    try {
      ...
      getProjectDetails(project["id"]);
      Fluttertoast.showToast(
          msg: "Congratualations on having your Project Completed.",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.CENTER,
          timeInSecForIosWeb: 1,
          backgroundColor: Colors.black12,
                          ...
                          children: <Widget>[
                            project["isAwarded"]
                                ? ResizableActionButton(
                                    ...
                                    text: 'Completed',
                                    width: 120,
                                    isButtonDisabled: project["isCompleted"],
                                  )
                                : ResizableActionButton(
                                    color: Colors.blueAccent,
                                    textColor: Colors.white,
                                    onPress: () async {
                                      var isDeleted = await Navigator.pushNamed(
                                          context, EditProject.id,
                                          arguments: project);
                            ...
                            ResizableActionButton(
                              ...
                              textColor: Colors.white,
                              onPress: () {
                                Navigator.pushNamed(context, ShowBids.id,
                                    arguments: project);
                              },
                              text: 'Show Bids',
                              width: 220,
