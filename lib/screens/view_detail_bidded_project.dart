...
class ViewDetailBiddedProject extends StatefulWidget {
  static const String id = "Bid Information";

  const ViewDetailBiddedProject({
    Key key,
  ...
  @override
  _ViewDetailBiddedProjectState createState() =>
      _ViewDetailBiddedProjectState();
}

class _ViewDetailBiddedProjectState extends State<ViewDetailBiddedProject> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      bidDetails = ModalRoute.of(context).settings.arguments;
      project = bidDetails["projectDetails"];
